...
class ResNet(nn.Module):
    def __init__(self, n_blocks, multi_grids, output_stride, resnet_backnone = 'ResNet50'):
        ...
        if (resnet_backnone == 'ResNet50'):
            resnet = models.resnet50()
        elif (resnet_backnone == 'ResNet101'):
            resnet = models.resnet101()
        elif (resnet_backnone == 'ResNet152'):
